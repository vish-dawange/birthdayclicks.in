...
<div id="wrapper">
	...
	<div id="menu">
		<ul>
			<li><a href="/bdayclicks/uindex.jsp">HOME</a></li>
			<li><a href="/bdayclicks/profile.jsp">PROFILE</a></li>
			<li><a href="/bdayclicks/usms.jsp">SMS</a></li>
			<li class="current_page_item"><a href="/bdayclicks/usubsms.jsp">SUBMIT SMS</a></li>
	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				...
				<!-- end #content -->
				<iframe src="/bdayclicks/subsms1.html" width=1024x height="650" align="center" name="mainifrsubsms"  frameBorder="0"></iframe>
