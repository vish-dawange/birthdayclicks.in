...
<body>
	<div id="sidebar1">
		<ul>
			<li>
				<h2><center>Submit Your Feedback</center></h2><br>
					<!--<iframe width="600" height="450" align="right" name="ifr" border="1"></iframe>-->				
							<form name="fback" method="post" action="/bdayclicks/subfeed.jsp">
							<table align="center" >
								...
								<tr height="20"></tr>
								<tr><td width="120"> <font color="white" size="3" face="comic sans ms"><b>Email-Id  :</td>
								<td width="150"><input style="width:150px;color:#808080;font-style:italic;margin:0;" type="text" name="mail" size="20"/></td></tr>
								<tr height="20"></tr>
								<tr><td width="120"> <font color="white" size="3" face="comic sans ms"><b>Mobile No.	:</td>
								<td width="150"><input style="width:150px;color:#808080;font-style:italic;margin:0;" type="text" name="mobno" size="20"/></td></tr>
								<tr height="20"></tr>
								<tr>
								<td width="120"><font color="white" size="3" face="comic sans ms"><b>Message :</font></td>
								<td width="150"><textarea cols="30" rows="6" name="msg"></textarea></tr>
