...
<div id="wrapper">
	...
	<div id="menu">
		<ul>
			...
			<li class="current_page_item"><a href="/bdayclicks/ucontact.jsp">CONTACT</a></li>
		</ul>
	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				...
				<!-- end #content -->
				<iframe src="/bdayclicks/contact1.html" width=1024x height="650" align="center" name="mainifrcontact"  frameBorder="0"></iframe>
