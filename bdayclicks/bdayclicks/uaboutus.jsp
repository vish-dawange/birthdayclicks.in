...
<div id="wrapper">
	...
	<div id="menu">
		<ul>
			...
			<li class="current_page_item"><a href="/bdayclicks/uaboutus.jsp">ABOUT</a></li>
	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				...
				<!-- end #content -->
				<iframe src="/bdayclicks/aboutus1.html" width=1024x height="650" align="center" name="mainifraboutus"  frameBorder="0"></iframe>
